...
const productSlice = createSlice({
  ...
  { name: 'Mint Leaves', price: 10, image: '/images/mintleaves.png', description: 'Cool and refreshing mint leaves.' },
    ...
    nonVeg: [
      { name: 'Chicken Breast', price: 100, image: '/images/chikenbreast.png', description: 'Lean chicken breast perfect for healthy meals.' },
      { name: 'Pork Ribs', price: 120, image: '/images/porkribs.png', description: 'Juicy pork ribs slow-cooked.' },
      { name: 'Fish Fillets', price: 160, image: '/images/fishfillets.png', description: 'Fresh fish fillets for grilling.' },
      { name: 'Mutton Chops', price: 180, image: '/images/muttonchobs.png', description: 'Tender mutton chops for roasting.' },
      { name: 'Duck Meat', price: 250, image: '/images/duckmeat.png', description: 'Rich duck meat with savory flavor.' },
      { name: 'Lamb Shank', price: 220, image: '/images/lambshunk.png', description: 'Succulent lamb shank for stews.' },
      { name: 'Beef Steak', price: 50, image: '/images/beafsteak.png', description: 'Premium beef steak for grilling.' },
      ...
      { name: 'Turkey Meat', price: 270, image: '/images/turkeychiken.png', description: 'Lean turkey meat ideal for sandwiches.' },
      
  { name: 'Crab Meat', price: 280, image: '/images/crabmeat.png', description: 'Fresh crab meat perfect for seafood dishes.' },
  { name: 'Prawns', price: 320, image: '/images/prawns.png', description: 'Juicy prawns ideal for curry and fry.' },
  { name: 'Squid Rings', price: 260, image: '/images/squidrings.png', description: 'Tender squid rings for frying and grilling.' },
  ...
  { name: 'Fish Curry Cuts', price: 110, image: '/images/fishcurrycuts.png', description: 'Fresh fish curry cuts ready to cook.' },
  { name: 'Buffalo Meat', price: 210, image: '/images/buffalomeat.png', description: 'Rich and nutritious buffalo meat.' },
  ...
  { name: 'Octopus', price: 320, image: '/images/octopus.png', description: 'Tender octopus meat for exotic recipes.' },
  { name: 'Rabbit Meat', price: 240, image: '/images/rabbitmeat.png', description: 'Lean rabbit meat, great for slow cooking.' },
  { name: 'Ham Slices', price: 170, image: '/images/hamslices.png', description: 'Raw ham slices ready for curing or cooking.' },
  ...
  { name: 'Chicken Sausages', price: 190, image: '/images/chickensausage.png', description: 'Raw chicken sausages for grilling.' },
  { name: 'Duck Breast', price: 260, image: '/images/duckbreast.png', description: 'Tender duck breast perfect for roasting.' },
  ...
  { name: 'Cashew Milk', price: 115, image: '/images/cashewmilk.png', description: 'Smooth cashew milk, perfect for desserts.' },
  ...
  { name: 'Camel Milk', price: 150, image: '/images/camelmilk.png', description: 'Exotic camel milk with medicinal properties.' },
  ...
  { name: 'Vanilla Milk', price: 70, image: '/images/vanillamilk.png', description: 'Mild vanilla flavored milk.' },
  ...
  { name: 'Quinoa Milk', price: 140, image: '/images/quinoamilk.png', description: 'Grain-based quinoa milk alternative.' },
  { name: 'Macadamia Milk', price: 130, image: '/images/macadamia.png', description: 'Rich macadamia nut milk.' },
  { name: 'Pistachio Milk', price: 125, image: '/images/pistachiomilk.png', description: 'Delicate pistachio-flavored milk.' },
  { name: 'Avocado Milk', price: 150, image: '/images/avocadomilk.png', description: 'Creamy and healthy avocado milk.' },
  ...
  { name: 'Milkybar', price: 25, image: '/images/milkybar.png', description: 'Creamy white chocolate delight.' },
  { name: 'Amul Dark Chocolate', price: 100, image: '/images/amuldark.png', description: 'Rich and bitter dark chocolate.' },
  { name: 'Galaxy', price: 120, image: '/images/galaxy.png', description: 'Smooth and silky milk chocolate.' },
  { name: 'Lindt Lindor', price: 350, image: '/images/lindt.png', description: 'Premium truffle-filled chocolate.' },
  { name: 'Nestle Classic', price: 50, image: '/images/nestleclassic.png', description: 'Classic milk chocolate bar.' },
  { name: 'Mars Bar', price: 45, image: '/images/mars.png', description: 'Caramel and nougat chocolate.' },
  { name: 'Twix', price: 40, image: '/images/twix.png', description: 'Crunchy biscuit with caramel chocolate.' },
  { name: 'Ritter Sport', price: 150, image: '/images/ritter.png', description: 'German chocolate with various flavors.' },
  ...
  { name: 'Temptations', price: 60, image: '/images/temptations.png', description: 'Cadbury’s rich premium chocolate bar.' },
  { name: 'Dairy Milk Roast Almond', price: 45, image: '/images/dmroastalmond.png', description: 'Chocolate with roasted almonds.' },
  { name: 'Hershey’s Kisses', price: 220, image: '/images/hersheyskisses.png', description: 'Iconic bite-sized chocolates.' },
  { name: 'Hershey’s Cookies & Cream', price: 90, image: '/images/hersheycookies.png', description: 'White chocolate with cookie bits.' },
  ...
  { name: 'Fabelle', price: 300, image: '/images/fabelle.png', description: 'ITC’s luxury handcrafted chocolate.' },
